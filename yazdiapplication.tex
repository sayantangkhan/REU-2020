...
Therefore one can glue together the two non-vanishing vector fields over $\widehat{F}$ and $A$ to a non-vanishing vector field over the surface $F_{n,k}$, proving the relative orientability of this surface.
